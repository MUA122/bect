...
const impactStats = [
  { value: 300, suffix: "+", label: { en: "Employees", ar: "موظفًا" } },
  {
    value: 800,
    suffix: "+",
    label: { en: "Projects Delivered", ar: "مشروعًا تم تسليمه" },
  },
  {
    value: 35,
    suffix: "+",
    label: { en: "Years of Experience", ar: "عامًا من الخبرة" },
  },
  {
    value: 10,
    prefix: "$",
    suffix: "B+",
    label: { en: "Construction Value", ar: "قيمة إنشائية" },
  },
  ...
  en: [
    ...
    },
    {
      ...
      groups: [
        {
          title: "Regions",
          items: ["Egypt", "Africa", "Middle East", "North Africa", "Europe"],
        },
        {
          title: "Sectors",
          items: [
    ...
    },
    {
      ...
      groups: [
        {
          title: "Company",
          items: ["Our story", "Leadership", "Our approach"],
        },
  ...
  ar: [
      ...
      groups: [
        ...
        },
        {
          ...
          items: [
            ...
            "الأعمال الكهروميكانيكية ومكافحة الحريق",
            "إدارة المشروعات والإشراف على المواقع",
          ],
        },
      ],
    },
    {
      ...
      groups: [
        {
          title: "المناطق",
          items: ["مصر", "أفريقيا", "الشرق الأوسط", "شمال أفريقيا", "أوروبا"],
        },
        {
          title: "القطاعات",
          items: [
...
const copy = {
  en: {
    ...
    form: {
      ...
      intro:
        "Tell us a little about your project. Our team will get back to you shortly.",
      name: "Full name",
      email: "Work email",
      phone: "Phone number",
      company: "Company",
      ...
      endpoint:
        "Google Sheets connection is ready. Add your Apps Script URL to GOOGLE_SHEETS_ENDPOINT.",
  ...
  ar: {
    ...
    form: {
      ...
      endpoint:
        "النموذج جاهز للربط. أضف رابط Google Apps Script في GOOGLE_SHEETS_ENDPOINT.",
        ...
        <>
          <Box
            sx={{
              width: "1px",
              height: 35,
              bgcolor: light ? "rgba(255,255,255,.3)" : "rgba(0,91,143,.22)",
            }}
          />
          <Typography
            sx={{
...
function LoadingScreen({ visible, language, progress, compact = false }) {
  ...
  useEffect(() => {
    ...
    const timer = window.setInterval(
      () =>
        setPhrase((current) => (current + 1) % copy[language].loading.length),
      900,
    );
  ...
  return (
    <Fade in={visible} timeout={{ enter: 0, exit: 700 }} unmountOnExit>
      <Box
        className={`loading-screen ${compact ? "is-transition" : ""}`}
      ...
      >
        ...
        <Box sx={{ width: "min(78vw, 430px)", textAlign: "center" }}>
          <Typography key={`${language}-${phrase}`} className="loading-phrase">
            {copy[language].loading[phrase]}
          </Typography>
          <Box className="loading-track">
            <Box sx={{ width: `${progress}%` }} />
          </Box>
          <Typography className="loading-percent">
...
function ImpactSection({ language }) {
  ...
  return (
    <Box
      component="section"
      ref={sectionRef}
      className={`impact-section ${visible ? "is-visible" : ""}`}
    >
      ...
      <Container maxWidth="xl" className="impact-container">
        {impactStats.map((stat, index) => (
          <Box
            ...
            sx={{ "--stat-index": index }}
          >
            <Typography className="impact-index" aria-hidden="true">
            ...
            <Typography className="impact-stat-label">
              {stat.label[language]}
            </Typography>
          </Box>
        ))}
...
function App() {
    ...
    () =>
      nav.map((item, index) => ({
        ...
        href:
          index === 0
            ? "#home"
            : `#${["home", "expertise", "projects", "about", "contact"][index]}`,
      })),
    [nav],
  );
  ...
  return (
    <Box
      id={currentPage === "home" ? "home" : undefined}
      dir={isArabic ? "rtl" : "ltr"}
      sx={{ minHeight: "100svh", bgcolor: "#06273b" }}
    >
      <LoadingScreen
        visible={loading}
        language={language}
        ...
        <Container maxWidth="xl" sx={{ position: "relative" }}>
          <Toolbar className="glass-header" disableGutters>
            ...
            <Stack
              ...
              alignItems="center"
              sx={{ ml: isArabic ? 0 : "auto", mr: isArabic ? "auto" : 0 }}
            >
              <Button
              ...
              <IconButton
                ...
                sx={{ display: { md: "none" }, color: "#173346" }}
              >
                <MenuRounded />
              </IconButton>
            </Stack>
      ...
      {currentPage === "expertise" ? (
        ...
        <>
          <Box component="main" className="hero">
            ...
            <Container maxWidth="xl" className="hero-layout">
              <Box className="hero-copy">
                ...
                >
                  ...
                  />
                  <Typography className="impact-label">
                    {text.impact}
                  </Typography>
                </Stack>
                <Typography
                  component="h1"
                  className={`hero-title ${isArabic ? "arabic" : ""}`}
                >
                  {text.headline}
              ...
              <Box className="project-bar">
                <Box sx={{ color: "white", minWidth: 0 }}>
                  <Typography className="selected-label">
                    {text.selected} · {String(active + 1).padStart(2, "0")}
                  </Typography>
            ...
            <Stack
              direction="row"
              className={`side-stats ${isArabic ? "rtl" : ""}`}
            >
      ...
      >
        ...
        <Stack component="nav" sx={{ mt: 5 }}>
          {links.map((item, index) => (
            ...
            >
              {item.label}
              <Typography sx={{ color: "rgba(255,255,255,.35)", fontSize: 10 }}>
                0{index + 1}
              </Typography>
            </Button>
          ))}
        ...
        <DialogContent className="contact-content">
          <Box className="contact-brand">
            ...
            <Box className="contact-brand-copy">
              <Typography className="contact-eyebrow">
                {text.form.eyebrow}
              </Typography>
              <Typography component="h2" className="contact-title">
                {text.form.title}
              </Typography>
            ...
            <Typography className="contact-mark">
              35<span>+</span>
            </Typography>
          </Box>
          ...
          >
            <Box className="contact-fields">
              ...
              <TextField
                name="interest"
                label={text.form.interest}
                select
                required
                fullWidth
                defaultValue=""
              >
                {text.form.interests.map((interest) => (
