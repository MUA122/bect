  ...
  if (code === "EG") {
    return (
      <svg {...commonProps}>
        ...
        <path
          d="m12 6.1 1.15 1.05-.42 2.05h-1.46l-.42-2.05L12 6.1Z"
          fill="#c79b2b"
        />
      </svg>
    );
  ...
  if (code === "OM") {
    return (
      <svg {...commonProps}>
        ...
        <path
          d="M1.7 2.1h2.8M2.1 1.4l2 2.1M4.1 1.4l-2 2.1"
          stroke="#fff"
          strokeWidth=".55"
          strokeLinecap="round"
        />
...
const featuredProjectId = "al-mukaymen-city";
...
function CategoryMark({ category }) {
  return (
    <span
      className="projects-category-mark"
        ...
        <Container maxWidth="xl" className="projects-shell">
          <Box className="projects-hero-grid">
            <Box className="projects-hero-copy">
              <Typography className="projects-eyebrow">
                {text.eyebrow}
              </Typography>
        ...
        <Container maxWidth="xl" className="projects-shell">
          ...
          >
            <Box className="projects-filter-heading">
              <Box>
                <Typography className="projects-filter-kicker">
                  {text.eyebrow}
                </Typography>
                <Typography id="projects-filter-title" component="h2">
                  {text.filterTitle}
                </Typography>
              </Box>
            </Box>
            ...
            <>
              <Box className="projects-grid">
                {filtered.slice(0, visibleCount).map((project, index) => {
                  const itemCategory = projectCategories.find(
                  ...
                  const projectLocation = localizeProject(
                    project,
                    "location",
                    language,
                  );
                  const projectYear = localizeProject(
                    project,
                    "year",
                    language,
                  );
                  ...
                  return (
                    ...
                    >
                      <Box className="project-card-visual">
                        ...
                        <Box className="project-card-number">
                          {String(index + 1).padStart(2, "0")}
                        </Box>
                        <Box className="project-card-badge">
                          <CategoryMark category={itemCategory} />
                          {itemCategory.label[language]}
                        </Box>
                        <button
                          type="button"
                          className="project-card-open"
                          aria-label={`${text.view}: ${projectName}`}
                        >
                          <ArrowOutwardRounded />
                        </button>
                      </Box>
          ...
          <Box className="projects-contact">
            <Box>
              ...
              <Typography>
                {isArabic
                  ? "يجمع فريقنا التخصصات المناسبة منذ الفكرة وحتى التنفيذ."
                  : "Bring the right disciplines together, from first idea through delivery."}
              </Typography>
            </Box>
          ...
          (() => {
            ...
            return (
              <DialogContent
                ...
                style={{ "--category": itemCategory.color }}
              >
                <IconButton
                ...
                <Box className="project-dialog-image">
                  <img
                    src={selected.image}
                    alt={projectName}
                    onError={handleProjectImageError}
                ...
                <Box className="project-dialog-copy">
                  <Box className="project-dialog-badge">
                    <CategoryMark category={itemCategory} />
                    {itemCategory.label[language]}
                  </Box>
